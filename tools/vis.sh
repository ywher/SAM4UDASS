...
output_root="/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/tools/outputs"

### dianyuan
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/dianyuan' \
...
mask_root="/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/cityscapes/sam_masks"
...
# mask_root="/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/DensePASS"
...
# densepass val
# mask_root="/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/DensePASS_val"
...
# do
#     python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything-old/outputs/kyxz/'$scene \
...
# do
#     python vis_mask.py \
#     --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything-old/outputs/miyuan_parking/'$dir \
...
###
# python vis_mask.py \
# --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything-old/outputs/fenxian/132' \
# --image_folder '/media/ywh/pool1/yanweihao/projects/MTMC/AIC21-MTMC/datasets_fenxian/detection/132_crop' \
...
### fisheye
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/fish-sjtu/train' \
...
### NTHU
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/NTHU/Rio' \
...
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/NTHU/Rome' \
...
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/NTHU/Taipei' \
...
### school
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/school1' \
# --image_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/tools/school1' \
...
# ivfc zhuitong
# python vis_mask.py --mask_folder '/media/ywh/pool1/yanweihao/projects/segmentation/segment-anything/outputs/ivfc/zhuitong' \
