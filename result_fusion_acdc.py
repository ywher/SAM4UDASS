...
from fusion.fusion_acdc import Fusion_ACDC
import os
import cv2
...
if __name__ == '__main__':
    ...
    fusion = Fusion_ACDC(mask_folder, 
                        mask_suffix,
                        segmentation_folder,
                        segmentation_suffix,
    ...
    for i in index_range:
        ...
        image_name = image_name.replace('_rgb_anon', '')
        ...
        uda_pred = cv2.imread(prediction_path, 0) #[h, w] 1 channel
