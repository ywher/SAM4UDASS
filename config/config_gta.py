...
mask_root = '/media/ywh/1/yanweihao/projects/segmentation/segment-anything'
mask_folder = f'{mask_root}/outputs/cityscapes/train_vith_2'
mask_suffix = '.png'

# the path to the model prediction
# daformer
uda_root = '/media/ywh/1/yanweihao/projects/uda/DAFormer/work_dirs/local-exp7/gta/230522_2312_gta2cs_dacs_a999_fdthings_rcs001_cpl_daformer_sepaspp_mitb5_poly10warm_s0_ea659'
...
# sepico
# uda_root = '/media/ywh/1/yanweihao/projects/uda/SePiCo/work_dirs/local-exp1/230707_0324_dlv2_proj_r101v1c_sepico_DistCL-reg-w1.0-start-iter3000-tau100.0-l3-w1.0_rcs0.01_cpl_self_adamw_6e-05_pmT_poly10warm_1x2_40k_gta2cs_seed76_36629'
# segmentation_folder = f'{uda_root}/pred_trainid'
# confidence_folder = f'{uda_root}/pred_confidence'
# entropy_folder = f'{uda_root}/pred_entropy'
...
# mic
# best
# uda_root = '/media/ywh/1/yanweihao/projects/uda/MIC/seg/work_dirs/local-exp80/230716_1343_gtaHR2csHR_1024x1024_dacs_a999_fdthings_rcs001-20_cpl2_m64-07-spta_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_ea911'
# segmentation_folder = f'{uda_root}/pred_trainid'
# confidence_folder = f'{uda_root}/pred_confidence'
# entropy_folder = f'{uda_root}/pred_entropy'

# baseline
# uda_root = '/media/ywh/1/yanweihao/projects/uda/MIC/seg/work_dirs/local-exp80/230711_0741_gtaHR2csHR_1024x1024_dacs_a999_fdthings_rcs001-20_cpl2_m64-07-spta_hrda1-512-01_daformer_sepaspp_sl_mitb5_poly10warm_s0_139ce'
# segmentation_folder = f'{uda_root}/pred_trainid'
# confidence_folder = f'{uda_root}/pred_confidence'
# entropy_folder = f'{uda_root}/pred_entropy'

# tufl stage 1
# uda_root = '/media/ywh/1/yanweihao/projects/uda/BiSeNet-uda/outputs/GTA5_deeplab_BiSeNet_20kunsup_adapt_focal_0.8_0.01'
